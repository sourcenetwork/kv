...
func TestIteratorReverse_Badger(t *testing.T) {
...
func TestIteratorReverse_MemoryUnnamespaced(t *testing.T) {
	test := &integration.Test{
		SupportedStoreTypes: []state.StoreType{
...
func TestIteratorReverse_MemoryNamespaced(t *testing.T) {
	test := &integration.Test{
		SupportedStoreTypes: []state.StoreType{
			state.MemoryStoreType,
		},
